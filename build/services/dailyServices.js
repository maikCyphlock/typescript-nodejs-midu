...
exports.AddDaily = exports.getEntriesWithoutSensitiveInfo = exports.findById = exports.getEntries = void 0;
...
const AddDaily = (NewDailyEntry) => {
    const NewDaily = Object.assign({ id: Math.max(...diaries.map(d => d.id)) + 1 }, NewDailyEntry);
    diaries.push(NewDaily);
    return NewDaily;
};
exports.AddDaily = AddDaily;
